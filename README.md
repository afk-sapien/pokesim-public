...
```sh
git clone --branch v0.2.0rc2 --depth 1 https://github.com/afk-sapien/pokesim-public.git pokesim
cd pokesim
cp .env.example .env
mkdir -p roms data
...
```sh
curl -fL --retry 3 -o image-linux-amd64.tar.gz https://github.com/afk-sapien/pokesim-public/releases/download/v0.2.0rc2/image-linux-amd64.tar.gz
curl -fL --retry 3 -o SHA256SUMS https://github.com/afk-sapien/pokesim-public/releases/download/v0.2.0rc2/SHA256SUMS
